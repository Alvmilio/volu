...
export default function ModificarInventario() {
  ...
  function modificarInventario()
  {
    axios
    .post(
      "http://18.223.121.116:4000/bodega/modificarInventario",
      {
          ID_bodega: bodega,
...
const listaBodegas = bodegas.map((element) => {
  ...
  return (
    ...
    <form autoComplete="off">
      <h1 align="center">Modificar Inventario por Bodega</h1>
    ...
    <button className="btn-primary" onClick={() => modificarInventario()}>
      {" "}
      Modificar
    </button>
    </div>
